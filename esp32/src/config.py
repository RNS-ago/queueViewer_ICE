...
WIFI_RETRIES         = 0         # connection attempts at startup before giving up
...
LOG_URL          = "http://10.209.82.139:3000/api/log"
AUTH_TOKEN       = ""            # must match the server's AUTH_TOKEN, or "" to disable
